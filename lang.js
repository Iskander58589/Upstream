...
const translations = {
  ru: {
    ...
    'reviews.author1': 'Мустафа Ерболулы',
    'reviews.meta1': '1 отзыв',
    'reviews.date1': '9 September 2026',
    'reviews.text1': 'Это очень лучший образовательный центр, где я чувствую настоящую энергию роста. Учителя добрые, терпеливые и профессиональные, а каждый урок помогает мне становиться увереннее в будущем.',
    'reviews.author2': 'Оксана Десятова',
    'reviews.meta2': '1 отзыв',
    'reviews.date2': '9 September 2026',
    'reviews.text2': 'Как родитель, я ценю, что мой ребёнок растёт в атмосфере тепла и вдохновения. Учителя внимательны, пространство поддерживает развитие, а результаты очевидны.',
    'reviews.author3': 'Алина К.',
    'reviews.meta3': '1 отзыв',
    'reviews.date3': '12 September 2026',
    'reviews.text3': 'Уроки структурированы, мотивируют и всегда поддерживают. Особенно ценю, что здесь дети ощущают себя комфортно и уверенно. Здесь обучение становится захватывающим.',
    'reviews.author4': 'Дархан Б.',
    'reviews.meta4': '1 отзыв',
    'reviews.date4': '15 September 2026',
    'reviews.text4': 'Я пришёл на подготовку к экзаменам и остался из-за атмосферы. Учителя объясняют понятно, студенты чувствуют уважение, а каждый урок имеет смысл. Центр действительно вдохновляет.',
  ...
  en: {
    ...
    'reviews.author1': 'Mustafa Erboluly',
    'reviews.meta1': '1 review',
    'reviews.date1': '9 September 2026',
    'reviews.text1': 'This is the very best educational center, where I can truly feel the energy of growth. The teachers are kind, patient and highly professional, and every lesson makes me more confident in my future.',
    'reviews.author2': 'Oksana Desyatova',
    'reviews.meta2': '1 review',
    'reviews.date2': '9 September 2026',
    'reviews.text2': 'As a parent, I value that my child grows in a warm and inspiring environment. The teachers are attentive, the space supports development, and the results are obvious.',
    'reviews.author3': 'Alina K.',
    'reviews.meta3': '1 review',
    'reviews.date3': '12 September 2026',
    'reviews.text3': 'The lessons are structured, motivating and always supportive. I especially value that children feel comfortable and confident here. Learning becomes exciting.',
    'reviews.author4': 'Darkhan B.',
    'reviews.meta4': '1 review',
    'reviews.date4': '15 September 2026',
    'reviews.text4': 'I came for exam preparation and stayed for the atmosphere. Teachers explain clearly, students feel respected, and every lesson has purpose. The center is truly inspiring.',
